...
TOKEN = "g5rsVhu3NoAAAAAAAAAAAR-E7xZ5aDJqfR3nMnmZPts-YNgMZbcyypd-aObXOwbS"

parser = argparse.ArgumentParser(description="Sync TestFiles to Dropbox")
parser.add_argument(
    "folder", nargs="?", default="TestFiles", help="Folder name in your Dropbox"
)
parser.add_argument(
    "rootdir", nargs="?", default="./TestFiles", help="Local directory to upload"
)
parser.add_argument(
    "--token",
    default=TOKEN,
...
def main():
    ...
    if sum([bool(b) for b in (args.yes, args.no, args.default)]) > 1:
        ...
        sys.exit(2)
    if not args.token or not TOKEN:
